...
/**
 * checks the awnser against the first element in 
...
/**
 * Gets the operands (the number) and the operator (minus plus etc)
...
/**
 * increments points to the score 
 */
...
/**
 * increments points to the wrong answers 
 */
